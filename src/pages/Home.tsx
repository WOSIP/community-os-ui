        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6 leading-tight">
              ...
              <span className="text-orange-500">{t("hero.title_exclusive")}</span> <br />
              {t("hero.title_part2")}
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { 
                ...
                val: t("stats.countries.value"), 
                desc: t("stats.countries.desc") 
              },
              { 
                label: t("stats.investment.label"), 
                val: t("stats.investment.value"), 
                desc: t("stats.investment.desc") 
              },
              { 
                label: t("stats.revenue.label"), 
                val: t("stats.revenue.value"), 
                desc: t("stats.revenue.desc") 
              }
            ].map((stat, idx) => (
              <motion.div 
                key={idx}
        ...
        <div className="grid md:grid-cols-2 gap-px bg-white/10 rounded-[1.5rem] overflow-hidden border border-white/10 shadow-xl">
          <div className="bg-zinc-950 p-8 md:p-12 text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
              ...
              <span className="text-xl font-bold text-blue-500 uppercase">{t("comparison.visa.label")}</span>
              <span className="text-[9px] font-bold text-blue-500 uppercase tracking-widest mt-1">{t("comparison.visa.sublabel")}</span>
            </div>
            <ul className="space-y-6">
              <li className="flex gap-4 items-start">
                ...
                <p className="text-base text-gray-400">
                  <Trans i18nKey="comparison.visa.point1">
                    Fournit l'infrastructure aux <span className="text-white font-bold">Banques</span> uniquement.
                  </Trans>
                </p>
              </li>
              <li className="flex gap-4 items-start">
                ...
                <p className="text-base text-gray-400">
                  <Trans i18nKey="comparison.visa.point2">
                    Cible les <span className="text-white font-bold">Clients bancarisés</span> individuels.
                  </Trans>
                </p>
              </li>
              <li className="flex gap-4 items-start">
                ...
                <p className="text-base text-gray-400">
                  <Trans i18nKey="comparison.visa.point3">
                    Nécessite des <span className="text-white font-bold">Licences e-money</span> lourdes et complexes.
                  </Trans>
                </p>
              </li>
            </ul>
          ...
          <div className="bg-zinc-950 p-8 md:p-12 relative text-center md:text-left">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
              ...
              <span className="text-xl font-bold text-orange-500 uppercase">{t("comparison.hellopass.label")}</span>
              <span className="text-[9px] font-bold text-orange-400 uppercase tracking-widest mt-1">{t("comparison.hellopass.sublabel")}</span>
            </div>
            <ul className="space-y-6">
              <li className="flex gap-4 items-start">
                ...
                <p className="text-base text-white">
                  <Trans i18nKey="comparison.hellopass.point1">
                    Fournit l'infrastructure aux <span className="text-orange-500 font-bold underline decoration-2">Communautés</span>.
                  </Trans>
                </p>
              </li>
              <li className="flex gap-4 items-start">
                ...
                <p className="text-base text-white">
                  <Trans i18nKey="comparison.hellopass.point2">
                    Cible les <span className="text-orange-500 font-bold">Membres</span> de ces écosystèmes.
                  </Trans>
                </p>
              </li>
              <li className="flex gap-4 items-start">
                ...
                <p className="text-base text-white">
                  <Trans i18nKey="comparison.hellopass.point3">
                    Système de <span className="text-orange-500 font-bold">Vouchers</span> – Aucune licence e-money.
                  </Trans>
                </p>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase tracking-tight">
              {t("closed_loops.title_part1")} <br /><span className="text-orange-500">{t("closed_loops.title_accent")}</span>
            </h2>
            ...
            <div className="space-y-3">
              {[
                t("closed_loops.point1"),
                t("closed_loops.point2"),
                t("closed_loops.point3")
              ].map((item, i) => (
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="bg-zinc-900 p-6 rounded-2xl border border-white/10 relative overflow-hidden group hover:border-orange-500/30 transition-all">
                <h3 className="text-lg font-bold mb-2 uppercase tracking-tight">{t("bnpl.traditional_title")}</h3>
                <p className="text-gray-400 font-medium text-[11px]">{t("bnpl.traditional_desc")}</p>
              ...
              <div className="bg-orange-500 p-6 rounded-2xl text-white shadow-lg shadow-orange-500/20 group hover:scale-[1.02] transition-transform">
                <h3 className="text-lg font-bold mb-2 uppercase tracking-tight">{t("bnpl.merchant_title")}</h3>
                <p className="text-white/90 font-bold text-[11px]">{t("bnpl.merchant_desc")}</p>
                <Smartphone className="mt-4 text-white/50" size={24} />
              </div>
          </div>
          <div className="order-1 md:order-2">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase tracking-tight">
              {t("bnpl.section_title_part1")} <span className="text-orange-500">{t("bnpl.section_title_accent")}</span>
            </h2>
            <p className="text-base text-gray-400 mb-6 leading-relaxed font-medium">
              <Trans i18nKey="bnpl.description">
          ...
          <div className="flex flex-col md:flex-row gap-5 justify-center items-center">
             <Link to="/candidature">
              <Button size="lg" className="bg-white text-orange-500 hover:bg-zinc-100 h-14 px-10 text-lg font-bold rounded-xl border-none shadow-xl group">
                {t("cta.button")} <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <div className="text-white font-bold flex flex-col items-start md:items-center text-left md:text-center">
               <span className="text-2xl font-bold text-white">{t("cta.stats_value")}</span>
               <span className="uppercase tracking-[0.2em] text-[9px] opacity-80">{t("cta.stats_label")}</span>
            </div>
          </div>
        </div>
      </section>
