    ...
    <div className="bg-black text-white py-16 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 pt-20">
          <h1 className="text-3xl md:text-5xl lg:text-7xl font-black mb-4 uppercase tracking-tighter leading-[0.9]">
            <Trans 
        ...
        <div className="grid lg:grid-cols-3 gap-10 items-start">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="p-8 bg-zinc-950 rounded-[2rem] border border-white/5 space-y-8 shadow-xl relative overflow-hidden">
              <div className="flex gap-5 items-start">
                <div className="w-10 h-10 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 shadow-lg shrink-0">
                  <Mail size={20} />
                </div>
                <div>
            ...
            <div className="p-8 bg-orange-500 rounded-3xl text-white shadow-xl transition-transform hover:scale-[1.01]">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-zinc-950 p-8 md:p-12 rounded-[3rem] border border-white/5 space-y-8 relative overflow-hidden shadow-xl">
