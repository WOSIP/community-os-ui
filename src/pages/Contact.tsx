      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 uppercase tracking-tight">
            {t("contact.title")}<span className="text-orange-500">{t("contact.title_accent")}</span>
          </h1>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="p-8 bg-zinc-950 rounded-[2rem] border border-white/5 space-y-8 group hover:border-orange-500/30 transition-all shadow-xl relative overflow-hidden">
              <div className="flex gap-5 items-start relative z-10">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-0.5 uppercase tracking-tight">{t("contact.email_label")}</h4>
                  <p className="text-gray-400 font-bold text-sm break-all">franchise@helloopass.net</p>
                  <p className="text-[7px] text-orange-500 font-bold uppercase tracking-[0.4em] mt-1.5">{t("contact.email_response")}</p>
                </div>
              </div>
              ...
              <div className="flex gap-5 items-start relative z-10">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-0.5 uppercase tracking-tight">{t("contact.hq_label")}</h4>
                  <p className="text-gray-400 font-bold text-sm leading-relaxed">
                    <Trans i18nKey="contact.hq_address">
              ...
              <div className="flex gap-5 items-start relative z-10">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-0.5 uppercase tracking-tight">{t("contact.support_label")}</h4>
                  <p className="text-gray-400 font-bold text-sm leading-relaxed">
                    <Trans i18nKey="contact.support_hours">
                      Lundi - Vendredi <br />
                      09:00 - 18:00 (GMT+1)
                    </Trans>
                  </p>
            ...
            <div className="p-6 bg-orange-500 rounded-2xl text-white shadow-xl transition-transform hover:scale-[1.01]">
              ...
              <h3 className="text-xl font-bold mb-2 uppercase tracking-tight italic">{t("contact.emergency_title")}</h3>
              <p className="font-bold mb-6 text-white/90 text-sm leading-relaxed">{t("contact.emergency_desc")}</p>
            ...
            <form onSubmit={handleSubmit} className="bg-zinc-950 p-8 md:p-12 rounded-[2.5rem] border border-white/5 space-y-8 relative overflow-hidden shadow-xl">
              <div className="grid md:grid-cols-2 gap-6 relative z-10">
                <div className="space-y-2">
                  <Label className="text-gray-500 font-bold uppercase tracking-[0.2em] text-[7px]">{t("contact.form_name")}</Label>
                  <Input 
                    required
                ...
                <div className="space-y-2">
                  <Label className="text-gray-500 font-bold uppercase tracking-[0.2em] text-[7px]">{t("contact.form_email")}</Label>
                  <Input 
                    type="email" 
                    required
              ...
              <div className="grid md:grid-cols-2 gap-6 relative z-10">
                <div className="space-y-2">
                  <Label className="text-gray-500 font-bold uppercase tracking-[0.2em] text-[7px]">{t("contact.form_phone")}</Label>
                  <Input 
                    type="tel" 
                    required
                ...
                <div className="space-y-2">
                  <Label className="text-gray-500 font-bold uppercase tracking-[0.2em] text-[7px]">{t("contact.form_territory")}</Label>
                  <select 
                    ...
                    required
                  >
                    <option value="">{t("contact.form_territory_placeholder")}</option>
              ...
              <div className="space-y-2 relative z-10">
                <Label className="text-gray-500 font-bold uppercase tracking-[0.2em] text-[7px]">{t("contact.form_message")}</Label>
                <Textarea 
                  rows={5}
              ...
              <Button type="submit" className="w-full bg-orange-500 hover:bg-orange-600 h-14 text-lg font-bold rounded-xl shadow-lg transition-all active:scale-[0.98] group relative z-10">
                {t("contact.form_submit")} <Send className="ml-3 group-hover:translate-x-1 transition-transform" size={20} />
              </Button>
            </form>
          </div>
        </div>
